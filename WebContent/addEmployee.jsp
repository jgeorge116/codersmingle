...
<html>
	...
	<body>
		...
		<div class="row main" style="margin-right: 0px !important;">
			...
			<div class="col-md-5">
				<a href = "addExistingEmployee.jsp" >
					<button type="submit"  class = "option_button" name="action" value="addExistingEmployee.jsp" >
						Old Person
					</button>
				</a>
				<br>
				<a href = "addNewEmployee.jsp">
					<button type="submit"  class = "option_button" name="action" value="addNewEmployee.jsp">
						New Person
					</button>
				</a>
				<br>
