...
<%@ page session="true" %>
<%@ page import="java.util.ArrayList, DBUtils.DBTransactions, object_classes.Dates, userType.UserType" %>
	...
	<body>
		...
		<div class="row main" style="margin-right: 0px !important;">
			...
			<div class="col-md-10">
				...
				<%
				ArrayList<String> dates = (ArrayList<String>) request.getSession().getAttribute("dates");
