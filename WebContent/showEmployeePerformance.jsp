...
<%@ page import="java.util.ArrayList, DBUtils.DBTransactions, object_classes.Employee, userType.UserType" %>
...
<html>
	...
	<body>
		...
		<div class="row main" style="margin-right: 0px !important;">
			...
			<%
			ArrayList<String> users = DBTransactions.getCustRepsWithMostRevenue();
