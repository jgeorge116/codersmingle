...
function Submit_onclick() {
	if(document.registerForm.profileB.value == ""  || document.registerForm.profileC.value == ""){
	...
	<body>
		...
		<div class="row main" style="margin-right: 0px !important;">
			...
			<div class="col-md-5">
			<form name="registerForm" action="blindDate" method="post">
				<div class="form-group">
					<label for="profileB">ProfileB: </label> <input type="text"
						class="form-control" name="profileB" id="profileB" placeholder="profileB">
				</div>

				<div class="form-group">
					<label for="profileC">ProfileC: </label> <input type="text"
						class="form-control" name="profileC" id="profileC" placeholder="profileC">
				</div>
