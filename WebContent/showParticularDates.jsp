...
<html>
	...
	<body>
		...
		<div class="row main" style="margin-right: 0px !important;">
			...
			<%
			String person = (String)  session.getAttribute("particularCustomer");
			ArrayList<String> users = DBTransactions.getCustomersWhoHaveDatedAParticularPerson(person, person);
