...
function Submit_onclick() {
	...
	isValid &= validDay(document.registerForm.day);
	isValid &= validPay(document.registerForm.pay);

	if(isValid){
		isValid &= isValidDate(parseInt(document.registerForm.month), parseInt(document.registerForm.date), parseInt(document.registerForm.year))
	}


	for(var i = 0; i < document.registerForm.pay.length; i++){
		if(isNaN(document.registerForm.pay.charAt(i) - '0')){
			isValid &= false;
		}
	}
	...
	<body>
		...
		<div class="row main" style="margin-right: 0px !important;">
			...
			<div class="col-md-5">
			<form name="registerForm" action="addExistingEmployee" method="post">
