...
function Submit_onclick() {
	...
	<body>
		...
		<div class="row main" style="margin-right: 0px !important;">
			...
			<div class="col-md-5">
				<a href = "addExistingCustomer.jsp" >
					<button type="submit"  class = "option_button" name="action" value="addExistingCustomer.jsp" >
						Old Person
					</button>
				</a>
				<br>
				<a href = "addNewCustomer.jsp">
					<button type="submit"  class = "option_button" name="action" value="addNewCustomer.jsp">
						New Person
					</button>
				</a>
				<br>
